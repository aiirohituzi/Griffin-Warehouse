...
<div class="container-expCalc">
    ...
    <div id="tdoll" class="tab-exp">
        ...
        <div class="inputGroup-exp" v-if="command">    
            ...
            <div class="input-addon-right">{{ commandSkillLv }}레벨 {{ commandSkill[commandSkillLv - 1] }}%</div>
        </div>
...
export default {
  ...
  data () {
    return {
      ...
      area: [
        {id: 0, name: '4-3e 거지런', exp: 370 * 4, penalty: 65},
        {id: 1, name: '0-2 거지런', exp: 490 * 5, penalty: 100},
        {id: 2, name: '8-1n 자스런', exp: 500 * 5, penalty: 111},
